...
RESOURCES += src/qt/privix.qrc src/qt/privix_locale.qrc

TRANSLATIONS += src/qt/locale/privix_bg.ts \
                src/qt/locale/privix_de.ts \
                src/qt/locale/privix_en.ts \
                src/qt/locale/privix_es.ts \
                src/qt/locale/privix_fi.ts \
                src/qt/locale/privix_fr.ts \
                src/qt/locale/privix_it.ts \
                src/qt/locale/privix_ja.ts \
                src/qt/locale/privix_pl.ts \
                src/qt/locale/privix_pt.ts \
                src/qt/locale/privix_ru.ts \
                src/qt/locale/privix_sk.ts \
                src/qt/locale/privix_sv.ts \
                src/qt/locale/privix_vi.ts \
                src/qt/locale/privix_zh_CN.ts \
                src/qt/locale/privix_zh_TW.ts
