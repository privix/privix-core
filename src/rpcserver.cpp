...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Privix features */
        {"privix", "masternode", &masternode, true, true, false},
        {"privix", "listmasternodes", &listmasternodes, true, true, false},
        {"privix", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"privix", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"privix", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"privix", "getmasternodecount", &getmasternodecount, true, true, false},
        {"privix", "masternodeconnect", &masternodeconnect, true, true, false},
        {"privix", "masternodecurrent", &masternodecurrent, true, true, false},
        {"privix", "masternodedebug", &masternodedebug, true, true, false},
        {"privix", "startmasternode", &startmasternode, true, true, false},
        {"privix", "createmasternodekey", &createmasternodekey, true, true, false},
        {"privix", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"privix", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"privix", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"privix", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"privix", "getmasternodescores", &getmasternodescores, true, true, false},
        {"privix", "mnbudget", &mnbudget, true, true, false},
        {"privix", "preparebudget", &preparebudget, true, true, false},
        {"privix", "submitbudget", &submitbudget, true, true, false},
        {"privix", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"privix", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"privix", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"privix", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"privix", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"privix", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"privix", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"privix", "checkbudgets", &checkbudgets, true, true, false},
        {"privix", "mnsync", &mnsync, true, true, false},
        {"privix", "spork", &spork, true, true, false},
        {"privix", "getpoolinfo", &getpoolinfo, true, true, false},
        {"privix", "makekeypair", &makekeypair, true, true, false},
#ifdef ENABLE_WALLET
        /* Wallet */
		...
		{"wallet", "dumpprivkey", &dumpprivkey_vpx, true, false, true},
		{"wallet", "dumpwallet", &dumpwallet, true, false, true},
		{ "wallet", "dumpallprivatekeys", &dumpallprivatekeys_vpx, true, false, true },
        ...
        {"zerocoin", "getzvpxseed", &getzvpxseed, false, false, true},
        {"zerocoin", "setzvpxseed", &setzvpxseed, false, false, true}
