                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Privix Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Privix address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and privix: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Privix Core"), this);
    aboutAction->setStatusTip(tr("Show information about Privix Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Privix"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Privix addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Privix addresses"));
    ...
    openAction->setStatusTip(tr("Open a Privix: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Privix Core help message to get a list with possible Privix command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Privix Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Privix network", "", count));
}
...
{
    QString strTitle = tr("Privix Core"); // default title
