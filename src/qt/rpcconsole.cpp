                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzvpxPathCustom = GetArg("-zvpxbackuppath", "");
    ...
    if(!strzvpxPathCustom.empty()) {
        ui->wallet_customzvpxbackuppath->setText(QString::fromStdString(strzvpxPathCustom));
        ui->wallet_customzvpxbackuppath_label->setVisible(true);
        ui->wallet_customzvpxbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzvpxPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to The Privix RPC console.") + "<br>" + 
