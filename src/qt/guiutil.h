...
/** Utility functions used by the Privix Qt UI.
 */
namespace GUIUtil
{
...
// Render Privix addresses in monospace font
...
// Parse "privix:" URI into recipient object, return true on successful parsing
