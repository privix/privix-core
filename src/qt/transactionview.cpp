 ...
 */
    ...
    typeWidget->addItem(tr("Received Vpx from zVpx"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zVpx"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zVpx));
