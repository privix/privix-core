...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(VPX);
    unitlist.append(mVPX);
    unitlist.append(uVPX);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case VPX:
        return QString("privix");
    case mVPX:
        return QString("mprivix");
    case uVPX:
        return QString::fromUtf8("uprivix");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case VPX:
            return QString("tVPX");
        case mVPX:
            return QString("mtVPX");
        case uVPX:
            return QString::fromUtf8("μtVPX");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case VPX:
            return QString("VPX");
        case mVPX:
            return QString("Milli-VPX (1 / 1" THIN_SP_UTF8 "000)");
        case uVPX:
            return QString("Micro-VPX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case VPX:
            return QString("TestVPXs");
        case mVPX:
            return QString("Milli-TestVPX (1 / 1" THIN_SP_UTF8 "000)");
        case uVPX:
            return QString("Micro-TestVPX (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
