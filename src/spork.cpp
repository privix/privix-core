...
// Privix: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_DISABLE_OBFUSCATION_ENFORCEMENT) r = SPORK_17_DISABLE_OBFUSCATION_DEFAULT;
        if (nSporkID == SPORK_18_SEGWIT_ACTIVATION) r = SPORK_18_SEGWIT_ACTIVATION_DEFAULT;
        if (nSporkID == SPORK_19_ZEROCOIN_MAINTENANCE_MODE) r = SPORK_19_ZEROCOIN_MAINTENANCE_MODE_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_DISABLE_OBFUSCATION_ENFORCEMENT") return SPORK_17_DISABLE_OBFUSCATION_ENFORCEMENT;
    if (strName == "SPORK_18_SEGWIT_ACTIVATION") return SPORK_18_SEGWIT_ACTIVATION;
    if (strName == "SPORK_19_ZEROCOIN_MAINTENANCE_MODE") return SPORK_19_ZEROCOIN_MAINTENANCE_MODE;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_DISABLE_OBFUSCATION_ENFORCEMENT) return "SPORK_17_DISABLE_OBFUSCATION_ENFORCEMENT";
    if (id == SPORK_18_SEGWIT_ACTIVATION) return "SPORK_18_SEGWIT_ACTIVATION";
    if (id == SPORK_19_ZEROCOIN_MAINTENANCE_MODE) return "SPORK_19_ZEROCOIN_MAINTENANCE_MODE";
