Contributing to Privix Core
============================

The Privix Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Privix Core project, and is not to be
confused with overall Privix Network Protocol consensus changes.

Whether a pull request is merged into Privix Core rests with the project merge
...
Patches that change Privix consensus rules are considerably more involved than
...
Where a patch set proposes to change the Privix consensus, it must have been
...
The project leader is the release manager for each Privix Core release.
