...
This mechanism has been integrated into Bitcore-Node-Privix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/privixproject/insight-api-privix#web-socket-api](https://github.com/privixproject/insight-api-privix#web-socket-api) 
* API: [https://github.com/privixproject/insight-api-privix#swifttx-transactions](https://github.com/privixproject/insight-api-privix#swifttx-transactions) 
...
By default, the Privix Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Privix Core daemon:
