...
Clone the git repositories for privix and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/privix/
git clone https://github.com/privix/gitian.sigs.git
git clone https://github.com/privix/privix-detached-sigs.git
```
