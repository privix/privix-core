...
In order to support loading of multiple wallets in privix-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is privix.cpp.
...
Changes to privix.cpp
----------------------
privix.cpp is the entry point into privix-qt, and as such, will require some minor modifications to provide hooks for
